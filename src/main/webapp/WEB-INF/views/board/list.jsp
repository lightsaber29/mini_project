						...
						<c:forEach items="${pageList.content}" var="board">
	                        ...
	                        <div class="blog_item_img">
	                          ...
	                          <a href="#" class="blog_item_date">
	                            ...
	                            <p><fmt:formatDate value="${parseDate}" pattern="MM" /></p>
	                          </a>
	                        </div>
	                        
	                        <div class="blog_details">
	                            <a class="d-inline-block" href="${pageContext.request.contextPath}/board/detail/${board.bno}">
	                                <h2>${board.subject}</h2>
	                            </a>
	                            <ul class="blog-info-link">
	                              ...
	                              Comments</a></li>
	                              <li><i class="far fa-heart"></i>${board.recommend} Likes</li>
	                            </ul>
	                        </div>
	                      </article>
						</c:forEach>
                          ...
                          <ul class="pagination">
							...
							<c:if test="${(startPage-blockCount) >0 }">
								<li class="page-item"><a class="page-link"
									href="${pageContext.request.contextPath}/board/list?nowPage=${startPage-1}"
							...
							<c:if test="${(startPage+blockCount)<=pageList.getTotalPages()}">
								<li class="page-item"><a class="page-link"
									href="${pageContext.request.contextPath}/board/list?nowPage=${startPage+blockCount}"
              ...
              <div class="col-lg-4">
                  <div class="blog_right_sidebar">
                      <aside class="single_sidebar_widget search_widget">
                          <form id="searchForm" action="${pageContext.request.contextPath}/board/list" method="post">
                      ...
                      <aside class="single_sidebar_widget newsletter_widget">
				            <h4 class="widget_title">Write</h4>
				            <form action="${pageContext.request.contextPath}/board/writeForm" method="post">
				            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
				                <button class="button rounded-0 primary-bg text-white w-100" type="submit">Write</button>
				            </form>
				      </aside>
