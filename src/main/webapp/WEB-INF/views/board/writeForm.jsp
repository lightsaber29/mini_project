...
<body>
  ...
  <section class="contact-section area-padding">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          <h2 class="contact-title">Write Form</h2>
        </div>
        <div class="col-lg-12">
          <form class="form-contact contact_form" action="${pageContext.request.contextPath}/board/insert" method="post" id="Form" enctype="multipart/form-data">
          <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
              <div class="col-12">
                <div class="form-group">
                  <input class="form-control" name="subject" id="subject" type="text" placeholder="Enter Subjeczzzzt">
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
