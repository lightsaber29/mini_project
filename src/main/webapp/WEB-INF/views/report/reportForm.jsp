...
<body>
  ...
  <section class="contact-section area-padding">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          <h2 class="contact-title">신고하기</h2>
        </div>
        <div class="col-lg-12">
          ...
          <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
              ...
              <hr>
              <div class="col-12">
                <h3 class="mb-20 title_color">사유 선택</h3>
					<h5 class="mb-3">여러 사유에 해당되는 경우, 대표적인 사유 1개를 선택해 주세요</h5>                	
                	<input type="radio" id="ad" name="reportContent" value="부적절한 홍보 게시글" class="primary-radio" checked="checked">
				  	<label for="html">부적절한 홍보 게시글</label><br>
					<input type="radio" id="forYouth" name="reportContent" value="음란성 또는 청소년에게 부적합한 내용" class="primary-radio">
				  	<label for="css">음란성 또는 청소년에게 부적합한 내용</label><br>
					<input type="radio" id="usurpation" name="reportContent" value="명예훼손/사생활 침해 및 저작권침해 등" class="primary-radio">
				  	<label for="css">명예훼손/사생활 침해 및 저작권침해 등</label><br>
					<input type="radio" id="hiddenCam" name="reportContent" value="불법촬영물 등 신고" class="primary-radio">
				  	<label for="html">불법촬영물 등 신고</label><br>
					<input type="radio" id="etc" name="reportContent" value="기타" class="primary-radio">
            ...
            <div class="form-group mt-3 d-flex justify-content-end col-12">
              <button type="submit" class="genric-btn danger-border radius e-large" id="reportBtn">신고하기</button>
              &nbsp&nbsp&nbsp
              <a href="javascript:history.back();" class="genric-btn danger-border radius e-large">취소</a>
            </div>
          </form>
