              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    ...
                    >
                      <th class="px-4 py-3">Client 신고인</th>
                      <th class="px-4 py-3">Content 신고내용</th>
                      <th class="px-4 py-3">Status 처리상태</th>
                      <th class="px-4 py-3">Date 신고날짜</th>
                      <th class="px-4 py-3">Actions 아 이거말고 그거 해야하나 신고글제목?? 뭘 신고하는지는 알아햐지않나..훙스 고민스바리바리</th>
                    </tr>
                  </thead>
                  <tbody
