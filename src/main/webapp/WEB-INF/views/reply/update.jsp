...
<div class="comment-form">
    <h4>Edit a Reply</h4>
    <form class="form-contact comment_form" action="${pageContext.request.contextPath}/reply/update" id="commentForm">
    	<input type="hidden" name="rno" value="${reply.rno}">
    	<input type="hidden" name="bno" value="${reply.board.bno}">
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    <textarea class="form-control w-100" name="replyContent" id="replyContent" cols="30" rows="9" placeholder="${reply.replyContent}"></textarea>
                </div>
            </div>
